...
class leetcode_1 :
   ...
   # 107. 二叉树的层序遍历 II (Binary Tree Level Order Traversal II)
    ...
    def sumOfMultiples(self, n: int) -> int:
       return (3 * (n // 3) + (n // 3) * (n // 3 - 1) * 3 // 2) + (5 * (n // 5) + (n // 5) * (n // 5 - 1) * 5 // 2) + (7 * (n // 7) + (n // 7) * (n // 7 - 1) * 7 // 2) - (15 * (n // 15) + (n // 15) * (n // 15 - 1) * 15 // 2) - (21 * (n // 21) + (n // 21) * (n // 21 - 1) * 21 // 2) - (35 * (n // 35) + (n // 35) * (n // 35 - 1) * 35 // 2) + (105 * (n // 105) + (n // 105) * (n // 105 - 1) * 105 // 2)
